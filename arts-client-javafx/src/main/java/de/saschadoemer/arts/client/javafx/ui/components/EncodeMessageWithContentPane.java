...
import de.saschadoemer.arts.api.exceptions.UUIDUtils;
...
public abstract class EncodeMessageWithContentPane extends DefaultGridPane {
    ...
    public void initComponents() {
        ...
        encodeMessageButton.setOnAction(event -> {
            this.messageAsBase64OutputProperty.set(StandardComponent.BLANK);
    ...
    public void initProperties() {
        ...
        this.teamSetContextIdInputProperty = new SimpleStringProperty(StandardComponent.BLANK);
