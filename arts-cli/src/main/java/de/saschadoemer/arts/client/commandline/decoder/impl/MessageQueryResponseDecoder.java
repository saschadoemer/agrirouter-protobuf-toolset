...
public class MessageQueryResponseDecoder implements ContentDecoder {

    @Override
    public Optional<Object> decode(Any content) {
        try {
            return Optional.ofNullable(FeedResponse.MessageQueryResponse.parseFrom(content.getValue()));
